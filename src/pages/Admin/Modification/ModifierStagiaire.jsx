...
const ModifierStagiaire = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Stagiaire modifié :", form);
    ...
    <div className="p-8" id="formulaire-stage">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">etablissement</label>
            <input
              type="text"
              name="etablissement"
