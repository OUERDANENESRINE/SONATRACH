    ...
    <div className="bg-white">
      ...
      <header className="absolute inset-x-0 top-0 z-50">
        ...
        <div className="flex justify-center">
          <hr className="border-t-2 border-black-300 dark:border-gray-600 w-1/2 mt-[-30px] mb-20" />
        </div>
                ...
                <div className="space-y-2 py-6">
                  {navigation.map((item) => (
                    <a
                      key={item.name}
                      href={item.href}
                      className="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-gray-900 hover:text-orange-500 hover:bg-gray-50 transition-colors duration-200 border-b-0"
